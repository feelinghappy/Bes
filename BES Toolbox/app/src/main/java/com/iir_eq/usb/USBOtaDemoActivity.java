 ...
 */
public class USBOtaDemoActivity extends BaseActivity implements View.OnClickListener , BESImpl.OnOtaCallBack{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_usb_ota_demo);
    ...
    private void initView() {
        ...
        mUsbDeviceText.setText(otaImpl.getProductString() + "");
